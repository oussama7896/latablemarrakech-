...
export const en: HomeStrings = {
  ...
  howto: {
    ...
    steps: [
      ...
      { n: '03', eyebrow: 'Step three · The evening', title: 'Sit down and enjoy.', body: 'A multi-course Moroccan feast served course by course on your terrace. Appetizers, mains, dessert, traditional mint tea. After the meal, full kitchen, dish, and table cleanup is included.', image: '/moroccan-feast-villa-terrace.webp', imageAlt: 'A long villa terrace dinner table set for a Moroccan feast at dusk', detail: '4 to 6 courses · 2.5 to 3 hours · We leave the villa cleaner' },
    ],
  },
  faq: {
...
export const fr: HomeStrings = {
  ...
  menu: {
    ...
    moreCourses: [
      ...
      { n: 'IX',   name: 'Pastilla de poisson · crevette, poisson blanc, chermoula', body: 'Petits feuilletés de warqa garnis de crevette et de poisson blanc liés à la chermoula, finis d&rsquo;un trait de citron confit. La pastilla plus légère.', note: 'Pescétarien', image: '/White-Fish-Spinach-Pastilla-560x300.png.webp', imageAlt: 'Pastilla de poisson au poisson blanc et chermoula en pâte warqa' },
...
export const ar: HomeStrings = {
  ...
  menu: {
    ...
    moreCourses: [
      ...
      { n: 'IX',   name: 'بسطيلة بحرية · جمبري، سمك أبيض، شرمولة', body: 'لفائف ورق ورقة بحشوة جمبري وسمك أبيض مع شرمولة، تُتمّ بعصرة من الليمون المخلّل. البسطيلة الأخف.', note: 'بحري', image: '/White-Fish-Spinach-Pastilla-560x300.png.webp', imageAlt: 'بسطيلة بحرية بالسمك الأبيض والشرمولة في عجين ورقة' },
